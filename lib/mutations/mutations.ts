...
export const REMOVE_CHARACTERISTIC = gql`
    mutation RemoveCharacteristic($characterisitcId:Int!){
        deleteChatbot_characteristics(id:$characterisitcId){
            id
        }
    }`
...
export const INSERT_GUEST = gql`
    mutation insertGuests($name:String!,$email:String!,$created_at: DateTime!){
