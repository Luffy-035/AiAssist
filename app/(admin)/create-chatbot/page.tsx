...
import { CREATE_CHATBOT } from '@/lib/mutations/mutations'
    ...
    return (
        <div className='flex flex-col items-center justify-center md:flex-row md:space-x-10 bg-white p-10 rounded-md m-10'>
            ...
            <div>
                ...
                <h2 className='font-light'>Create a new chatbot to assist you in your conversation with your customers.</h2>
